  ...
  <body>
    ...
    <script>
      ...
      fetch("https://afsaccess4.njit.edu/~cth9/CS490/student/getexamquestions.php", {
        ...
        for (var i in data) {
          examquestions += '<tr> <td>' + data[i]["id"] + '</td> <td>' + data[i]["question"] + '</td> <td>' + data[i]["difficulty"] + '</td> <td>' + data[i]["category"] + '</td> <td>' + data[i]["testcase1"] + ',' + data[i]["testcase2"] + '</td> <td>' + data[i]["pnts"] + '</td> </tr>';
        }
