...
<html lang="en">
  ...
  <body>
    ...
    <script>
      ...
      var obj = data;
      for(var i in obj) {
        questionBank += '<tr> <td class="col-md-1">' + obj[i]["id"] + '</td> <td class="col-md-1"> <div class="scrollable">' + obj[i]["question"] + '</div></td> <td class="col-md-2">' + obj[i]["difficulty"] + '</td> <td class="col-md-2">' + obj[i]["category"] + '</td> <td class="col-md-2">' + obj[i]["testcase1"] + '; ' + obj[i]["testcase2"];
      ...
      $("#bank tr").click(function(){
        ...
        $("#quesSelect tr.selected").each(function(){
          ...
          examtable += '<tr>  <td class="col-md-3">' + question + '</td> <td class="col-md-1">' + difficulty + '</td> <td class="col-md-1">' + category + '</td> <td class="col-md-1">' + testcases + '</td> <td class="col-md-1"> <input size="1" id="ques' + id + '" required> </td> </tr>';//type="number"
        });
